...
namespace tomocam {
     ...
     * @param tomocam::transforms::NUFFT::Grid non-unifrom grid on which NUFFT is
     * computed
     * @param boolean flag to indicate whether to apply the filter
     * @return DeviceArray<T> Image space
     */
    template <typename T>
    DeviceArray<T> backproject(const DeviceArray<T> &, const Grid<T> &, bool);
     ...
     */
    template <typename T>
    DeviceArray<T> project(const DeviceArray<T> &, const Grid<T> &);
     ...
     */
    template <typename T>
    DeviceArray<T> gradient(DeviceArray<T> &, DeviceArray<T> &, const Grid<T> &);
