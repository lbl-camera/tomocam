...
using tomocam::to_complex;
using tomocam::to_real;
using tomocam::concurrency::GPUToHost;
using tomocam::concurrency::Scheduler;
namespace NUFFT = tomocam::transforms::NUFFT;
namespace Machine = tomocam::utils::Machine;
using tomocam::transforms::NUFFT::nufft2d1;
using tomocam::transforms::NUFFT::nufft2d2;
