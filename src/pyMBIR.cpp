...
namespace tomocam {
    ...
    template <typename T>
    DArray<T> mbir_mpi(DArray<T> &sino, std::vector<T> &angles, T center,
                       int num_iters, T sigma, T tol, T xtol, bool file_write,
    ...
    template DArray<float> mbir_mpi(DArray<float> &, std::vector<float> &, float,
                                    int, float, float, float, bool,
                                    const std::string &);
    template DArray<double> mbir_mpi(DArray<double> &, std::vector<double> &, double,
