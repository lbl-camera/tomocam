...
namespace tomocam {
    ...
    class DeviceMemory {
      ...
      public:
        ...
        DeviceMemory(dim3_t d, size_t s, int2 h, T *ptr): 
            dims_(d), size_(s), halo_(h), dev_ptr_(ptr) {}
    ...
    typedef DeviceMemory<cuComplex_t> DeviceMemoryC;
