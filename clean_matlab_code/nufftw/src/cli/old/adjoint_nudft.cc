...
{
	// usage: adjoint_nudft trajfilename Ndim imagesize imagefilename kdatafilename Nthreads
	...
	read_data_file(kdatafilename, noncartesian_data); // possible: use Ndata=nuDFT_imp.Nsamples
